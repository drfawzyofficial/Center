...
router.get('/getProfile', checkAuth, Profile_Controller.getProfile);


// Signup Router => Post to /user/signup to execute this request
router.get('/getUsers', checkAuth, Profile_Controller.getUsers);


// Signup Router => Post to /user/signup to execute this request
router.get('/getInstructors', checkAuth, Profile_Controller.getInstructors);

// Signup Router => Post to /user/signup to execute this request
router.get('/getCourses', checkAuth, Profile_Controller.getCourses);


// Signup Router => Post to /user/signup to execute this request
router.get('/search', checkAuth, Profile_Controller.Search);
...
/*
eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJfaWQiOiI1ZjM0NzQyZjFlMmU4ZTA3ZDA4ZmEyZWEiLCJpYXQiOjE1OTcyNzMyNzksImV4cCI6MTU5NzM1OTY3OX0.76xUL7mO95w5hB3fvbRMGB1uJ7nMAS31mdCGZh7AF5M
*/